...
<script>
 ...
 window.addEventListener("keydown", (event) => {
    if (event.key === "d" || event.key === "D") { // 'D' key for moving right
    ...
    } else if (event.key === "a" || event.key === "A") { // 'A' key for moving left
        event.preventDefault();
        if (event.repeat) {
            mario.stopAnimate();
        } else {
    ...
    } else if (event.key === "w" || event.key === "W") { // 'W' key for moving up (if needed)
        event.preventDefault();
        // Add logic for the 'W' key if necessary
    } else if (event.key === "s" || event.key === "S") { // 'S' key for moving down (if needed)
        event.preventDefault();
        // Add logic for the 'S' key if necessary
    }
});
